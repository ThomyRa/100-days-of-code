...
def check_price(coffee_info, usr_choice, t_coins):
    ...
    if coffee_info[usr_choice]['cost'] > t_coins:
        ...
        print("Here is your cappuccino \N{hot beverage}. Enjoy")
...
while True:
    ...
    if type(coffee_selection) is bool and not coffee_selection:
        break
    elif type(coffee_selection) is bool and coffee_selection:
